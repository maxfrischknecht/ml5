// Source: 
// https://github.com/ml5js/ml5-library/blob/main/examples/p5js/Pix2Pix/Pix2Pix_callback/sketch.js
...
function setup() {
  ...
  inputImg = loadImage('images/aws.png', drawImage);
...
function transfer() {
  ...
  pix2pix.transfer(canvasElement, function(err, result) {
    ...
    if (result && result.src) {
      ...
      createImg(result.src).class('border-box').parent('outputContainer');
      // Show 'Done!' message
      statusMsg.html('Done!');
    }
  });
